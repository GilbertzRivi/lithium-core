...
use crate::labels::{DEK_WRAP_AAD, DEK_WRAP_VER};
use crate::secrets::bytes::SecretBytes;
use crate::secrets::{Byte32, Byte64, SecretString};

fn wrap_key(export_key: &Byte64) -> Result<Byte32> {
    kdf::derive32(
...
pub fn wrap_dek_under_export_key(dek: &Byte32, export_key: &Byte64) -> Result<SecretString> {
    let key = wrap_key(export_key)?;
...
pub fn unwrap_dek_under_export_key(blob_hex: &SecretString, export_key: &Byte64) -> Result<Byte32> {
